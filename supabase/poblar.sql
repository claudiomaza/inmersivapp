...
INSERT INTO resenas (id, usuario_id, actividad_id, puntuacion, comentario) VALUES
  ...
  ('a0000005-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000011', 4, 'Muy buena organización desde el principio hasta el final'),
  ('a0000006-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000011', 4, 'Muy buena organización desde el principio hasta el final'),
  ('a0000007-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000003', 4, 'La actividad es tal cual la describen. Muy recomendable'),
  ('a0000008-0000-0000-0000-000000000000', 'user_participante_4', 'a0000000-0000-0000-0000-000000000003', 5, 'El anfitrión tiene una energía increíble. Hizo la experiencia'),
  ('a0000009-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000003', 5, 'Muy lindo lugar y buena organización. Repetiría'),
  ('a0000010-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000013', 4, 'Recomiendo llevar ropa cómoda porque te movés bastante'),
  ('a0000011-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000013', 4, 'Me fui con ganas de más. Ojalá haya pronto otra fecha'),
  ('a0000012-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000015', 4, 'Recomiendo llevar ropa cómoda porque te movés bastante'),
  ('a0000013-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000015', 4, 'Muy buena organización desde el principio hasta el final'),
  ('a0000014-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000015', 5, 'La comunicación previa fue clara y todo salió según lo planeado'),
  ('a0000015-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000005', 4, 'Aprendí muchísimo y pasé un rato hermoso. Gracias!'),
  ('a0000016-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000005', 5, 'El anfitrión fue excelente, muy atento y profesional'),
  ('a0000017-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000005', 4, 'Una experiencia transformadora. Me llevé mucho más de lo que esperaba'),
  ('a0000018-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000016', 4, 'Me fui con ganas de más. Ojalá haya pronto otra fecha'),
  ('a0000019-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000016', 5, 'Me encantó la dinámica, el grupo y el entorno. 10/10'),
  ('a0000020-0000-0000-0000-000000000000', 'user_participante_4', 'a0000000-0000-0000-0000-000000000016', 5, 'El anfitrión fue excelente, muy atento y profesional'),
  ('a0000021-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000017', 5, 'Recomiendo llevar ropa cómoda porque te movés bastante'),
  ('a0000022-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000017', 5, 'Muy buena organización desde el principio hasta el final'),
  ('a0000023-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000008', 4, 'Superó todas mis expectativas. Volvería sin dudarlo'),
  ('a0000024-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000008', 5, 'Recomiendo llevar ropa cómoda porque te movés bastante'),
  ('a0000025-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000018', 4, 'Un plan diferente para hacer en Mendoza. Me encantó'),
  ('a0000026-0000-0000-0000-000000000000', 'user_participante_4', 'a0000000-0000-0000-0000-000000000018', 5, 'Actividad familiar, divertida y educativa a la vez'),
  ('a0000027-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000018', 4, 'Excelente relación calidad-precio. Super recomendable'),
  ('a0000028-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000019', 5, 'Nunca había hecho algo así. Me abrió la cabeza'),
  ('a0000029-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000019', 5, 'Nunca había hecho algo así. Me abrió la cabeza'),
  ('a0000030-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000009', 5, 'El anfitrión fue excelente, muy atento y profesional'),
  ('a0000031-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000009', 4, 'Una experiencia transformadora. Me llevé mucho más de lo que esperaba'),
  ('a0000032-0000-0000-0000-000000000000', 'user_participante_4', 'a0000000-0000-0000-0000-000000000009', 4, 'La actividad es tal cual la describen. Muy recomendable'),
  ('a0000033-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000010', 5, 'El paisaje es espectacular. Las fotos no le hacen justicia'),
  ('a0000034-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000010', 5, 'Muy buena organización desde el principio hasta el final'),
  ('a0000035-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000010', 4, 'Una experiencia transformadora. Me llevé mucho más de lo que esperaba'),
  ('a0000036-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000020', 5, 'La actividad es tal cual la describen. Muy recomendable'),
  ('a0000037-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000020', 5, 'Increíble experiencia, muy recomendable'),
  ('a0000038-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000020', 5, 'El paisaje es espectacular. Las fotos no le hacen justicia'),
  ('a0000039-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000004', 5, 'El paisaje es espectacular. Las fotos no le hacen justicia'),
  ('a0000040-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000004', 4, 'Muy lindo lugar y buena organización. Repetiría'),
  ('a0000041-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000021', 5, 'Un plan diferente para hacer en Mendoza. Me encantó'),
  ('a0000042-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000021', 4, 'Una experiencia transformadora. Me llevé mucho más de lo que esperaba'),
  ('a0000043-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000021', 5, 'Una experiencia única en Mendoza. No se la pierdan'),
  ('a0000044-0000-0000-0000-000000000000', 'user_participante_1', 'a0000000-0000-0000-0000-000000000006', 4, 'El anfitrión fue excelente, muy atento y profesional'),
  ('a0000045-0000-0000-0000-000000000000', 'user_participante_4', 'a0000000-0000-0000-0000-000000000006', 5, 'El anfitrión fue excelente, muy atento y profesional'),
  ('a0000046-0000-0000-0000-000000000000', 'user_participante_2', 'a0000000-0000-0000-0000-000000000007', 5, 'Muy buena organización desde el principio hasta el final'),
  ('a0000047-0000-0000-0000-000000000000', 'user_participante_3', 'a0000000-0000-0000-0000-000000000007', 4, 'Excelente relación calidad-precio. Super recomendable')
ON CONFLICT (id) DO NOTHING;
