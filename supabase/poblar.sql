...
INSERT INTO actividades (id, anfitrion_id, titulo, descripcion, categoria, fecha, hora, lugar, precio, capacidad_max, imagen_url) VALUES
  ...
  ('a0000000-0000-0000-0000-000000000022', 'user_anfitrion_2', 'Rafting en el Río Mendoza', 'El río Mendoza baja con fuerza desde la Cordillera, y sus rápidos son el escenario perfecto para una aventura que combina adrenalina y paisaje.Descenso en balsa por rápidos clase II y III. 2 horas de navegación, equipo de seguridad completo, instructores certificados y fotos de la experiencia. Incluye traslado desde Potrerillos y almuerzo al aire libre.', 'Aventura', '2026-09-19', '09:00', 'Potrerillos, Luján de Cuyo', 12000, 12, 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=800'),
  ...
  ('a0000000-0000-0000-0000-000000000006', 'user_anfitrion_7', 'Tejedora por un Día', 'El tejido andino es una tradición milenaria que las comunidades originarias de Mendoza mantienen viva. Cada diseño cuenta una historia, cada color tiene un significado.Aprendé telar mapuche y tejido andino con artesanas de la comunidad Huarpe de Lavalle. Te llevás tu tejido puesto. Incluye materiales, mateada durante la actividad y certificado de participación.', 'Cultura', '2026-08-26', '10:00', 'Lavalle', 6000, 8, 'https://images.unsplash.com/photo-1591123120776-7dfb24f3a2ab?w=800'),
