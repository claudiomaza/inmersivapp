      ...
      {abierto && (
        <div className="border-t border-gray-100 px-4 pb-4 pt-3">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {/* Categoría */}
            <div>
              <label className="mb-1 block text-xs font-semibold uppercase tracking-wide text-texto-secundario">
                Categoría
              </label>
              <select
          ...
          {/* Días de semana */}
          <div className="mt-4">
            <label className="mb-2 block text-xs font-semibold uppercase tracking-wide text-texto-secundario">
              Días de la semana
            </label>
